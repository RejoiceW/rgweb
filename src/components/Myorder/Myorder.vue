                ...
                <tr>
                  <td class="order-info" colspan="6">
                    <span class="order-text">
                      <span>订单号：</span>
                      <a class="link" href="">2344326331552234</a>
                    </span>
                    ...
                    <span class="order-text">
                      <span>订单总价：</span>
                      <span class="enhance">￥2799</span>
                    </span>
                    <a class="link pull-right" href="">查看详情&gt;</a>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="order-list-cell cell-info">
                    <a
                      ...
                      href=""
                      target="_blank"
                    >索尼（SONY）KD-65X8566E 65英寸4K HDR腾讯视频 安卓7.0智能液晶电视（黑色）</a>
                  </td>
...
.footer .slogen .item-con .item-txt {
  float: left;
  padding-left: 10px;
  height: 42px;
  line-height: 42px;
...
.footer .slogen .item-con .img-duo {
  float: left;
  width: 48px;
  height: 53px;
...
.footer .slogen .item-con .img-kuai {
  float: left;
  width: 48px;
  height: 53px;
...
.footer .slogen .item-con .img-hao {
  float: left;
  width: 48px;
  height: 53px;
...
.footer .slogen .item-con .img-sheng {
  float: left;
  width: 48px;
  height: 53px;
